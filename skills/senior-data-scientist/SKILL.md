...
description: >-
  World-class data science expertise covering statistical modeling, A/B testing, causal inference, feature engineering, and model evaluation using Python (NumPy, Pandas, Scikit-learn) and R. Use when designing experiments, building predictive models, performing causal analysis, engineering features, or producing data-driven reports.
